                    ...
                    <div class="card">
                        <div class="d-flex align-items-end row">
                            ...
                            <div class="col-4 pt-3 ps-0">
                                <img src="{{ asset('Cms/assets/img/illustrations/prize-light.png') }}" width="90"
                                ...
                                <div class="card-body">
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        <div class="avatar flex-shrink-0">
                                            <img src="{{ asset('Cms/assets/img/icons/unicons/wallet-info.png') }}"
                        ...
                        <div class="col-lg-6 col-md-3 col-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        <div class="avatar flex-shrink-0">
                                            <img src="{{ asset('Cms/assets/img/icons/unicons/briefcase.png') }}"
                                                alt="Credit Card" class="rounded">
                                        </div>
                                        <div class="dropdown">
                            ...
                            <ul class="p-0 m-0">
                                ...
                                <li class="d-flex mb-4">
                                    <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                                        ...
                                        <div class="user-progress">
                                            <i class='bx bx-down-arrow-alt text-danger me-2'></i> <span>- 8.5%
                                            </span>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="col-12 col-sm-6 col-md-3 col-lg-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        <div class="avatar flex-shrink-0">
                                            <img src="{{ asset('Cms/assets/img/icons/unicons/cc-warning.png') }}"
                                                alt="Credit Card" class="rounded">
                                        </div>
                                        <div class="dropdown">
                            ...
                            <table class="table text-nowrap">
                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('Cms/assets/img/products/oneplus-lg.png') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('Cms/assets/img/products/magic-mouse.png') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('Cms/assets/img/products/imac-pro.png') }}"
                                                    alt="Apple" height="32" width="32" class="me-2">
                                                <div class="d-flex flex-column">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('Cms/assets/img/products/note10.png') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('Cms/assets/img/products/iphone.png') }}"
                                                    alt="Apple" height="32" width="32" class="me-2">
                                                <div class="d-flex flex-column">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('Cms/assets/img/products/mi-tv.png') }}" alt="Xiaomi"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('Cms/assets/img/products/logitech-mx.png') }}"
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <small class="text-muted">You have done <span class="fw-medium">57.6%</span>
                                    more sales.<br>Check your new badge in your profile.</small>
                                <div>
                                    <span class="badge bg-label-warning p-2"><i
