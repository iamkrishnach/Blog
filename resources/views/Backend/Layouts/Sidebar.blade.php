<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ url('create-posts') }}" class="menu-link">
                        <div class="text-truncate" data-i18n="Create">Create</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ url('posts/view') }}" class="menu-link">
        ...
        {{-- <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ url('add-outer-catgeory') }}" class="menu-link">
                        <div class="text-truncate" data-i18n="Outer Category">Outer Category</div>
                    </a>
                </li>
                <li class="menu-item">
