...
<!-- Core CSS -->
<link rel="stylesheet" href="{{ asset('Cms/assets/vendor/css/rtl/core.css') }}" class="template-customizer-core-css">
...
<link rel="stylesheet" href="{{ asset('Cms/assets/vendor/libs/dropzone/dropzone.css') }}">
<link rel="stylesheet" href="{{ asset('Cms/assets/vendor/libs/flatpickr/flatpickr.css') }}">
<link rel="stylesheet" href="{{ asset('Cms/assets/vendor/libs/tagify/tagify.css') }}">

<!-- Page CSS -->
<link rel="stylesheet" href="{{ asset('Cms/assets/vendor/css/pages/card-analytics.css') }}">
