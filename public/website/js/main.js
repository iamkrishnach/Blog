...
//   if (scrolling > 300) {
//     $(".top_nav").addClass("fixedTopnav");
//   } else {
//     $(".top_nav").removeClass("fixedTopnav");
//   }
// });
...
document.querySelector('.scroll-link').addEventListener('click', function(event) {
  ...
  const targetDiv = document.querySelector('.tgtSkipdiv');
  const navbarHeight = document.querySelector('.navbar').offsetHeight;
  const targetPosition = targetDiv.getBoundingClientRect().top + window.pageYOffset - navbarHeight;
